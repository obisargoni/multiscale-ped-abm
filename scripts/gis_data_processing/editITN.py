...
data_directory = "S:\\CASA_obits_ucfnoth\\1. PhD Work\\GIS Data\\CoventGardenWaterloo\\Intersect Within layers\\"
link_shapefile = "mastermap-itn RoadLink Intersect Within.shp"
node_shapefile = "mastermap-itn RoadNode Intersect Within.shp"

output_dir = "S:\\CASA_obits_ucfnoth\\1. PhD Work\\GIS Data\\CoventGardenWaterloo\\Intersect Within layers\\"
...
gdf_itn = gpd.read_file(os.path.join(data_directory, link_shapefile))
...
gdf_itn_node = gpd.read_file(os.path.join(data_directory, node_shapefile))
...
gdf_itn_link = gpd.read_file(os.path.join(data_directory, link_shapefile))
