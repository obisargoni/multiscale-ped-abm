 ...
 * 
 * Edited by Obi to correct coordinate transforms
 *
 * @author Nick Collier
 * 
 */
public class ShapefileLoader<T> {
  ...
  private void initTransform(Geography geography, AttributeType type) throws FactoryException {
    ...
    CoordinateReferenceSystem gTypeCRS = gType.getCoordinateReferenceSystem();
    CoordinateReferenceSystem gCRS = geography.getCRS();
    if (geography != null) {
      try {
    	  /*
   ...
   * setting each agent's properties to the value of a
